...
op* op_parser_binary_node::_determine_op(const binary_request_header& header) {
	...
	case binary_header::opcode_get:
		r = new op_get(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_getq:
		r = new op_getq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_getk:
		r = new op_getk(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_getkq:
		r = new op_getkq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_set:
		r = new op_set(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_setq:
		r = new op_setq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_add:
		r = new op_add(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_addq:
		r = new op_addq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_replace:
		r = new op_replace(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_replaceq:
		r = new op_replaceq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_delete:
		r = new op_delete(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_deleteq:
		r = new op_deleteq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_increment:
		r = new op_incr(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_incrementq:
		r = new op_incrq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_decrement:
		r = new op_decr(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_decrementq:
		r = new op_decrq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	...
	case binary_header::opcode_flush:
		r = new op_flush_all(this->_connection, singleton<novadbd>::instance().get_storage());
		break;
	case binary_header::opcode_flushq:
		r = new op_flush_allq(this->_connection, singleton<novadbd>::instance().get_storage());
		break;
	case binary_header::opcode_version:
		r = new op_version(this->_connection); 
		break;
	case binary_header::opcode_append:
		r = new op_append(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_appendq:
		r = new op_appendq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_prepend:
		r = new op_prepend(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_prependq:
		r = new op_prependq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage()); 
		break;
	case binary_header::opcode_touch:
		r = new op_touch(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage());
		break;
	case binary_header::opcode_gat:
		r = new op_gat(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage());
		break;
	case binary_header::opcode_gatq:
		r = new op_gatq(this->_connection, singleton<novadbd>::instance().get_cluster(), singleton<novadbd>::instance().get_storage());
		break;
